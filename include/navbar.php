...
<nav id="conf" class="navbar navbar-expand-lg navbar-light bg-primary mt-5 mb-3 sticky-top">
        <div class="container">
            <a href="index.php" class="navbar-brand text-white font10 font-weight-bold p-2">RTIMES 2025 </a>
                ...
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-primary border-0">
                            ...
                            <a href="fee.php#conf" class="dropdown-item text-white bg-primary border-bottom">Registration Fees</a>
                            <a href="bankDetails.php#conf" class="dropdown-item text-white bg-primary border-bottom">Bank Details</a>
                            ...
                            <a href="program.php#conf" class="dropdown-item text-white bg-primary border-bottom">Conference
                                Patrons</a>
                            <a href="bankDetails.php#conf" class="dropdown-item text-white bg-primary border-bottom">Conference
                                Brochure</a>
                        </div>
                    </li>
