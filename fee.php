    ...
    <div class="container">
        ...
        <table class="table table1">
            <thead>
                ...
                <tr class="border">
                    <th class="border font1 text-danger">Early bird *<br>On or Before 30/4/2025</th>
            ...
            <tbody>
                <tr class="border">
                    ...
                    <td class="border font1">INR 1000 #</td>
                    <td class="border font1">USD 100</td>
                    
                </tr>
                <tr class="border">
                    <td class="border">Faculty Delegates(Main Author)</td>
                    <td class="border">INR 1000</td>
                    <td class="border">USD 100</td>
                    
                </tr>
                <tr class="border">
                    <td class="border">Faculty Delegates(co-Author(s)</td>
                    <td class="border">INR 800</td>
                    <td class="border">USD 70</td>
                    
                </tr>
                <tr class="border">
                    <td class="border">Additional paper(s)</td>
                    <td class="border">INR 500</td>
                    
                    <td class="border">USD 50</td>
        ...
        <br>
        <h5 class="first-bdr rounded pl-2 font-weight-bold mb-3 text-danger">AIP Publication charges of ₹9000 per paper has to be paid during registration by the Main Author</h5>
        <br>
        ...
        <div class="container">
            ...
            <table class="table table1"> 
                <tr class="border">
                    <td class="border font10 text-danger">* INR 200 & ** USD 5 extra after 15/05/2022</td>
                </tr>
                <tr class="border">
                    <td class="border font10 text-danger">* Additional charges are applicable for publications in SCOPUS indexed journals</td>
                </tr>
            </table>
	    	</p>
        </div> 
